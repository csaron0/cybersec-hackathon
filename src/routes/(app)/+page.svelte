<script lang="ts">
	...
	// Mock recent incidents for dashboard stats
...
<div class="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
	<div class="stat rounded-box bg-base-200">
		...
		<div class="stat-value text-primary">{dashboardStats.totalIncidents}</div>
	</div>
	...
	<div class="stat rounded-box bg-base-200">
		...
		<div class="stat-value text-warning">{dashboardStats.activeIncidents}</div>
	</div>
	...
	<div class="stat rounded-box bg-base-200">
		...
		<div class="stat-value text-error">{dashboardStats.criticalIncidents}</div>
	</div>
	...
	<div class="stat rounded-box bg-base-200">
		...
		<div class="stat-value text-success">{dashboardStats.resolvedToday}</div>
	</div>
</div>
